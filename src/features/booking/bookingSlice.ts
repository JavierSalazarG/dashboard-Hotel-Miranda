...
import { BookingSliceInterface, statusOptions } from "../../interfaces/booking/bookingSliceInterfaces";
...
export const getBookingsData = (state: { booking: BookingSliceInterface }) => state.booking.data;
export type BookingStatus = typeof statusOptions[number];

export const getBookingsStatus = (state: { booking: { status: BookingStatus } }) => state.booking.status;
export const getBookingsError = (state: { booking: BookingSliceInterface }) => state.booking.error;
